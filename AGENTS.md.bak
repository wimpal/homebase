...
**Build order and exit gates:** [docs/roadmap.md](docs/roadmap.md) is the source of truth for what to build and in what order.

**Rules for agents:**

1. Do **not** start Phase N+1 until Phase N's exit gate is met.
2. Finish foundation phases **0–3** before deepening feature modules.
3. Before implementing a README feature, read its audit section, definition of done, and assigned phase in the roadmap.
4. When shipping, follow [docs/release.md](docs/release.md) for milestone naming, release checklist, and supported deployments.

**Current focus:** Phase 0 is complete. Next: **Phase 1 — Secure household tenancy & authorization**.
...
- Do not skip roadmap phase gates or implement features from a later phase before prerequisites are met
- Do not use legacy `homebase_foundation_roadmap_*.plan.md` files — use `docs/roadmap.md` instead
...
0. Check the current phase and exit gate in `docs/roadmap.md` before implementing
...
- `docs/roadmap.md` — phases, audit, build order, exit gates
- `docs/release.md` — milestone naming, release checklist, supported deployments
- `docs/nas-deploy.md` — Docker Compose on NAS
